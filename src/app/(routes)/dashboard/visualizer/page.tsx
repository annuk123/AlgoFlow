...
//   { name: "Merge Sort", slug: "../dashboard/visualizer/merge-sort", description: "Visualize the divide and conquer approach of Merge Sort" },
//   { name: "Quick Sort", slug: "../dashboard/visualizer/quick-sort", description: "Watch Quick Sort in action" },
//   { name: "Heap Sort", slug: "../dashboard/visualizer/heap-sort", description: "Learn how Heap Sort builds a heap and sorts" },
//   { name: "Radix Sort", slug: "../dashboard/visualizer/radix-sort", description: "Visualize sorting by individual digit positions" },
//   { name: "Counting Sort", slug: "../dashboard/visualizer/counting-sort", description: "Learn how Counting Sort works with integers" },
//   { name: "Bucket Sort", slug: "../dashboard/visualizer/bucket-sort", description: "Visualize Bucket Sort for efficient sorting" },
